...
export class ButtonComponent {
  ...
  protected containerClasses = computed(() => {
    const base =
      'relative inline-flex w-full items-center justify-center font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-200 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-50 disabled:cursor-not-allowed disabled:opacity-50';
